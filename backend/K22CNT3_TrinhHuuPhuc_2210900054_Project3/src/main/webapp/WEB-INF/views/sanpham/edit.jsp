...
<body>
    ...
    <div class="content">
        ...
        <form action="/SpringMVCPagination/sanpham/editsave" method="post">
            <input type="hidden" name="maSP" value="${command.maSP}" />
            
            <label for="tenSP">Tên Sản Phẩm:</label>
            <input type="text" id="tenSP" name="tenSP" value="${command.tenSP}" required/>

            <label for="loaiSP">Loại Sản Phẩm:</label>
            <input type="text" id="loaiSP" name="loaiSP" value="${command.loaiSP}" required/>

            <label for="donViTinh">Đơn Vị Tính:</label>
            <input type="text" id="donViTinh" name="donViTinh" value="${command.donViTinh}" required/>

            <label for="giaNhap">Giá Nhập:</label>
            <input type="number" id="giaNhap" name="giaNhap" value="${command.giaNhap}" required/>

            <label for="soLuongTon">Số Lượng Tồn:</label>
            <input type="number" id="soLuongTon" name="soLuongTon" value="${command.soLuongTon}" required/>
