...
<body>
    ...
    <div class="content">
        ...
        <form action="/SpringMVCPagination/thptaikhoan/thpeditsave" method="post">
        
            <input type="hidden" name="thpMaTK" value="${command.thpMaTK}" />

            <label for="email">Email:</label>
            <input type="email" id="email" name="thpEmail" value="${command.thpEmail}" required/>

            <label for="matKhau">Mật Khẩu:</label>
            <input type="password" id="matKhau" name="thpMatKhau" value="${command.thpMatKhau}" required/>

            <label for="thpMaNV">Chọn Nhân Viên:</label>
            <select id="thpMaNV" name="thpNhanVien.thpMaNV" required>
                <option value="">-- Chọn Nhân Viên --</option>
                <c:forEach items="${thpNhanVienList}" var="nhanvien">
                    <option value="${nhanvien.thpMaNV}" ${command.thpNhanVien.thpMaNV == nhanvien.thpMaNV ? 'selected' : ''}>
                        ${nhanvien.thpHoTen}
                    </option>
                </c:forEach>
            </select>
        ...
        <a href="/SpringMVCPagination/thptaikhoan/thpview" class="back-link"><i class="fas fa-arrow-left"></i> Quay lại Danh Sách Tài Khoản</a>
    </div>
